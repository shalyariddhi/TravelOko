      ...
      builder: (_, ThemeMode currentMode, __) {
        return MaterialApp(
          ...
          theme: ThemeData(
            ...
            shadowColor: const Color(0xFFFF5E3A),
            primaryColor: const Color(0xFFFF5E3A),
            colorScheme: ColorScheme.fromSeed(
              seedColor: const Color(0xFFFF5E3A),
            ...
            textTheme: GoogleFonts.outfitTextTheme(ThemeData.light().textTheme).copyWith(
              bodyLarge: GoogleFonts.outfit(color: const Color(0xFF0F172A), fontWeight: FontWeight.w600),
              bodyMedium: GoogleFonts.outfit(color: const Color(0xFF5C6F84)),
              bodySmall: GoogleFonts.outfit(color: const Color(0xFF8A99AD)),
              titleLarge: GoogleFonts.outfit(color: const Color(0xFF0F172A), fontWeight: FontWeight.w900),
              titleMedium: GoogleFonts.outfit(color: const Color(0xFF0F172A), fontWeight: FontWeight.bold),
            ),
            ...
            appBarTheme: AppBarTheme(
              ...
              titleTextStyle: GoogleFonts.outfit(
                fontSize: 22, fontWeight: FontWeight.w900, color: const Color(0xFF0F172A),
              ),
            ...
            inputDecorationTheme: InputDecorationTheme(
              ...
              focusedBorder: OutlineInputBorder(
                borderRadius: BorderRadius.circular(16),
                borderSide: const BorderSide(color: Color(0xFFFF5E3A), width: 2),
              ),
              hintStyle: GoogleFonts.outfit(color: const Color(0xFF8A99AD)),
            ),
            dividerTheme: const DividerThemeData(color: Color(0xFFEFF1F6)),
